                                    ...
                                    <div class="card-toolbar">
                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                ...
                                                @if (Auth::user()->tipo == 1)
                                                    <a class="btn btn-danger btn-icon confirm-delete"
                                ...
                                <div class="card-footer pt-2 pb-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <span
                                                class="font-size-sm text-primary ml-2">{{ $cliente->fechacreacion }}</span>
                                        </div>
                                        <div class="col-md-4">
