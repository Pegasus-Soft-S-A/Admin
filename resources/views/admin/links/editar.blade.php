    ...
    <div class="d-flex flex-column-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!--begin::Card-->
                    <form class="form" action="{{ route('links.actualizar', $links->sis_linksid) }}" method="POST">
                        @method('PUT')
                                ...
                                <div class="card-toolbar">
                                    <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="">
                                        <div class="btn-group" role="group" aria-label="First group">
                                            ...
                                            <a href="{{ route('links.index') }}" class="btn btn-secondary btn-icon"
                                            ...
                                            <a href="{{ route('links.crear') }}" class="btn btn-warning btn-icon"
                            ...
                            <div class="card-footer pt-2 pb-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <span class="font-size-sm text-primary ml-2">{{ $links->usuariocreacion
                                            }}</span>
                                        <span class="font-size-sm text-primary ml-2">{{ $links->fechacreacion
                                            }}</span>
                                    </div>
                                    <div class="col-md-4">
                                        <span class="font-size-sm font-weight-bolder text-dark ml-2">Modificación</span>
                                        <span class="font-size-sm text-primary ml-2">{{ $links->usuariomodificacion
                                            }}</span>
                                        <span class="font-size-sm text-primary ml-2">{{ $links->fechamodificacion
                                            }}</span>
                                    </div>
                                </div>
                            </div>
