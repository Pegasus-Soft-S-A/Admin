        ...
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!--begin::Card-->
                        <form id="formulario" class="form" action="<?php echo e(route('clientes.actualizar', $cliente->sis_clientesid)); ?>" method="POST">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                ...
                                                <a href="<?php echo e(route('clientes.index')); ?>" class="btn btn-secondary btn-icon" data-toggle="tooltip"
                                                ...
                                                <?php if(Auth::user()->tipo == 1): ?>
                                                    <a class="btn btn-danger btn-icon confirm-delete" href="javascript:void(0)"
                                                        data-href="<?php echo e(route('clientes.eliminar', $cliente->sis_clientesid)); ?>" data-toggle="tooltip"
                                                ...
                                                <?php endif; ?>
                                                <?php if(Auth::user()->tipo != 4 && Auth::user()->tipo != 6 && Auth::user()->tipo != 8): ?>
                                                    <a href="<?php echo e(route('clientes.crear')); ?>" class="btn btn-warning btn-icon" data-toggle="tooltip"
                            ...
                            <div class="card-header flex-wrap py-5">
                                ...
                                <div class="card-toolbar">
                                    <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="">
                                        <div class="btn-group" role="group" aria-label="First group">
                                            <?php if(Auth::user()->tipo == 1 || Auth::user()->tipo == 2): ?>
                                                <a href="<?php echo e(route('licencias.Web.crear', $cliente->sis_clientesid)); ?>" class="btn btn-primary btn-icon"
                                            ...
                                            <?php endif; ?>
                                            <?php if(Auth::user()->tipo == 1 || Auth::user()->tipo == 2): ?>
                                                <a href="<?php echo e(route('licencias.Vps.crear', $cliente->sis_clientesid)); ?>" class="btn btn-secondary btn-icon"
