                            ...
                            <div class="card-header ">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <?php if(Auth::user()->tipo != 4 && Auth::user()->tipo != 6 && Auth::user()->tipo != 8): ?>
                                        <a href="<?php echo e(route('clientes.crear')); ?>" class="btn btn-primary font-weight-bolder">
                                            <span class="svg-icon svg-icon-md">
                                        ...
                                        <div class="col-lg-3 mb-lg-0 mb-6">
                                            ...
                                            <select class="form-control datatable-input select2" id="vendedor" name="vendedor">
                                                ...
                                                <?php $__currentLoopData = $vendedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($vendedor->sis_revendedoresid); ?>">
                                                        <?php echo e($vendedor->razonsocial); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-lg-3 mb-lg-0 mb-6">
                                            ...
                                            <select class="form-control datatable-input select2" id="revendedor" name="revendedor">
                                                <option value="">Todos</option>
                                                <?php $__currentLoopData = $revendedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($vendedor->sis_revendedoresid); ?>">
                                                        <?php echo e($vendedor->razonsocial); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#kt_datatable').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('clientes.tabla')); ?>",
                    type: 'POST',
                    data: function(d) {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin\resources\views/admin/clientes/index.blade.php ENDPATH**/ ?>