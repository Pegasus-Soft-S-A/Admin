    ...
    <div class="tab-pane fade" role="tabpanel" id="soporte">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-4">
                ...
                <input type="text" class="form-control" readonly value="<?php echo e($licencia->tickets_utilizados); ?>" />
            </div>
        </div>
        <div class="form-group row">
            <div class="col-lg-4">
                <label>Version ejecutable:</label>
                <input type="text" class="form-control" value="<?php echo e($licencia->version_ejecutable); ?>" readonly />
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                ...
                <input type="text" class="form-control" value="<?php echo e($licencia->fecha_respaldo); ?>" readonly />
            </div>
        </div>
    </div>
</div>
