    ...
    <div class="d-flex flex-column-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!--begin::Card-->
                    <form class="form" action="<?php echo e(route('licencias.Pc.actualizar', $licencia->sis_licenciasid)); ?>"
                            ...
                            <div class="card-footer pt-2 pb-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <span
                                            class="font-size-sm text-primary ml-2"><?php echo e($licencia->usuariocreacion); ?></span>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <span
                                            class="font-size-sm text-primary ml-2"><?php echo e($licencia->usuariomodificacion); ?></span>
                                        <span
                                            class="font-size-sm text-primary ml-2"><?php echo e($licencia->fechamodificacion); ?></span>
                                    </div>
                                </div>
                            </div>
