                    ...
                    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                        <div class="card-header ">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="<?php echo e(route('usuarios.crear')); ?>" class="btn btn-primary font-weight-bolder">
                                    <span class="svg-icon svg-icon-md">
...
<script>
    $(document).ready(function() {
            var table = $('#kt_datatable').DataTable({
                ...
                columns: [{
                        data: 'sis_distribuidores_usuariosid',
                        name: 'sis_distribuidores_usuariosid',
                        searchable: false,
                        visible: false
                    },
                    {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin\resources\views/admin/usuarios/index.blade.php ENDPATH**/ ?>