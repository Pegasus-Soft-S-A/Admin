        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!--begin::Card-->
                    <form class="form"
                        action="<?php echo e(route('usuarios.actualizar', $usuarios->sis_distribuidores_usuariosid)); ?>"
                        method="POST">
                                ...
                                <div class="card-toolbar">
                                    <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="">
                                        <div class="btn-group" role="group" aria-label="First group">
                                            ...
                                            <a href="<?php echo e(route('usuarios.index')); ?>" class="btn btn-secondary btn-icon"
                                            ...
                                            <a href="<?php echo e(route('usuarios.crear')); ?>" class="btn btn-warning btn-icon"
                            ...
                            <div class="card-footer pt-2 pb-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <span
                                            class="font-size-sm text-primary ml-2"><?php echo e($usuarios->usuariocreacion); ?></span>
                                        <span class="font-size-sm text-primary ml-2"><?php echo e($usuarios->fechacreacion); ?></span>
                                    </div>
                                    <div class="col-md-4">
                                        <span class="font-size-sm font-weight-bolder text-dark ml-2">Modificación</span>
                                        <span
                                            class="font-size-sm text-primary ml-2"><?php echo e($usuarios->usuariomodificacion); ?></span>
                                        <span
                                            class="font-size-sm text-primary ml-2"><?php echo e($usuarios->fechamodificacion); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function recuperarInformacion() {
        ...
        $.post('<?php echo e(route('identificaciones.index')); ?>', {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin\resources\views/admin/usuarios/editar.blade.php ENDPATH**/ ?>