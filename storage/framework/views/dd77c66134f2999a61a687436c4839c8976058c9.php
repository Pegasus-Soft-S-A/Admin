                    ...
                    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                        <div class="card-header ">
                            ...
                            <div class="card-toolbar">
                                <a href="<?php echo e(route('reportes.export_versiones')); ?>"
                ...
                <div class="col-md-6">
                    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                        <div class="card-header ">
                            ...
                            <div class="card-toolbar">
                                <a href="<?php echo e(route('reportes.export_respaldos')); ?>"
                                    class="btn btn-success font-weight-bolder">
                                    <span class="svg-icon svg-icon-md">
                                        <i class="flaticon-download"></i>
                                    </span>Descargar
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin\resources\views/admin/reportes/reportes.blade.php ENDPATH**/ ?>